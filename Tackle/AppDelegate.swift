...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        let tackleYellowDark = UIColor(red: 206/255, green: 144/255, blue: 0/255, alpha: 1)
        let navigationBarAppearance = UINavigationBar.appearance()
        let tabBarAppearance = UITabBar.appearance()
        navigationBarAppearance.barTintColor = tackleYellowLight
        navigationBarAppearance.titleTextAttributes = [NSAttributedStringKey.foregroundColor : tackleYellowDark]
        tabBarAppearance.barTintColor = tackleYellowLight
        tabBarAppearance.tintColor = tackleYellowDark
        return true
    }
